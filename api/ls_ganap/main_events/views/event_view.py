from main_events.models import Event, Recurrence
...
class EventRecurrence(generics.RetrieveUpdateAPIView):
    """
    get: 
    Returns an event given its id
    ...
    serializer_class = event_serializer.RecurrenceSerializer