...
urlpatterns = [
    ...
    path('events/event_hosts/<int:pk>/', event_view.HostEventsList.as_view()),
    ...
    path('events/tags/<int:pk>/', event_view.TagEventsList.as_view()),
    path('event_hosts/', host_view.HostList.as_view()),
    path('event_hosts/<int:pk>/', host_view.HostDetail.as_view()),
    path('event_hosts/clusters/<int:pk>', host_view.ClusterOrgsList.as_view()),
    path('event_hosts/host_types/<int:pk>', host_view.TypeHostList.as_view()),
