# Generated by Django 2.2.2 on 2019-07-23 04:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='org_host', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('name',),
            },
