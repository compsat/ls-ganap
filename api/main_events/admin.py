...
class EventAdmin(admin.ModelAdmin):
	...
	fields = ('deleted_at', 'created_at', 'updated_at', 'name', 'audience' , 'description', 'is_approved', 'poster_url', 'is_premium', 'event_url', 'tags', 'sanggu_hosts', 'office_hosts', 'org_hosts', 'created_by')
